...
Transaction.prototype.addOutput = function (scriptPubKey, value) {
  ...
  console.log("script: " + scriptPubKey);
...
Transaction.prototype.__toBuffer = function (buffer, initialOffset, __allowWitness) {
  ...
  this.outs.forEach(function (txOut) {
    ...
    const check = txOut.script.slice(0, 2)


    if(txOut.script.slice(0, 2).toString('hex') == "6a"){
      console.log("found the opreturn")
    }else{
      console.log("did not find the opreturn")
